...
% see the LICENSE file included with this software
    ...
    %% METHODS
        ...
        %   See also controller/execute
            ...
            elseif (obj.check_event('at_obstacle') || obj.check_event('obstacle_cleared')) && obj.is_in_state('avoid_obstacles')
            ...
            if obj.check_event('at_obstacle') && obj.is_in_state('go_to_goal') 
             ...
             if obj.is_in_state('follow_wall') && obj.check_event('progress_made')
               ...
               elseif  obj.check_event('sliding_right')
                ...
                obj.switch_to_state('follow_wall');
               elseif ~obj.check_event('sliding_left') && ~obj.check_event('sliding_right')
                   %fprintf("None")
                   obj.switch_to_state('follow_wall')
             ...
             if obj.is_in_state('follow_wall') && obj.check_event('progress_made') && ~obj.check_event('sliding_left') && ~obj.check_event('sliding_right')
                 obj.switch_to_state('go_to_goal')
             end
...
%             fprintf('current_pose: (%0.3f,%0.3f,%0.3f)\n', x, y, theta);
        ...
        function rc = progress_made(obj, state, robot)
            ...
            if abs([x - obj.goal(1);y-obj.goal(2)])< (obj.d_prog - 0.1)
                rc = true;
            end
